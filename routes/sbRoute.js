...
const {getHome, getAbout, getSongs, getEdit, getSong_list, getAdd_playlist, getGenres, getGenres_single, getDownload, getHistory, getRequest, getContact,getRegister, getCreate,getViewAllSongs,
...
router.route('/all_songs').get(getViewAllSongs)
...
router.route('/song_list').get(getSong_list).post(setSong_list)
...
router.route('/song_list/:id').put(getSong_list).delete(setSong_list)
